...
const WorksiteDetailsScreen = ({ route, navigation }) => {
  ...
  // Le client peut valider si le worker a terminé (workerStatus = 'work_completed') et que le client n'a pas encore validé
  const canValidate =
    isClient && worksite.workerStatus === 'work_completed' && !worksite.isValidatedByClient;
